...
# def convert_p2excel(input_file):
#     df = read_pdf(input_file, pages='all')[0]
#     convert_into(input_file, input_file.replace(".pdf",".csv"), output_format="csv", pages='all')
#     print(df)
#     return input_file.replace(".pdf",".csv")

def convert_pdf2image(input_file):
    # images = convert_from_path(input_file, poppler_path=r'C:\poppler-23.11.0\Library\bin')
