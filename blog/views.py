...
def index(request):
    ...
    categories=Posts.objects.filter(is_deleted=False).values('categorie__id', 'categorie__name_en_us', 'categorie__name_ru_ru', 'categorie__name_uz_crl', 'categorie__name_uz_uz').annotate(id=F('categorie__id'), name_en_us=F('categorie__name_en_us'), name_ru_ru=F('categorie__name_ru_ru'), name_uz_crl=F('categorie__name_uz_crl'), name_uz_uz=F('categorie__name_uz_uz'), total=Count('categorie__id')).values('id', 'name_en_us', 'name_ru_ru', 'name_uz_crl', 'name_uz_uz', 'total')
    if id != 0:
